from main import lexerAritmetico, determinar_tipo

O = ['Suma', 'Resta', 'Multiplicación', 'División', 'Potencia', 'Asignación']
...
def stateMachine(currentState, token):
    ...
    if currentState == 'q0':
        if token[1] == 'Variable' or token[1] == 'Entero' or token[1] == 'Real':
            return 'q1'
        elif token[1] == 'Paréntesis que abre':
            return 'q3'
        elif token[1] == 'Comentario':
            return 'q7'
        elif token[1] == 'Enter':
            return 'q0'
        elif token[1] in O or token[1] == 'Paréntesis que cierra':
            return 'q8'
        else: return 'qError'
    ...
    if currentState == 'q1':
        if token[1] in O:
            return 'q2'
        if token[1] == 'Paréntesis que abre':
            return 'q3'
        if token[1] == 'Comentario':
            return 'q7'
        if token[1] == 'Variable' or token[1] == 'Entero' or token[1] == 'Real' or token[1] == 'Paréntesis que cierra':
            return 'q8'
        if token[1] == 'Enter':
            return 'q0'
        else: return 'qError'
    ...
    if currentState == 'q2':
        if token[1] == 'Variable' or token[1] == 'Entero' or token[1] == 'Real':
            ...
            return 'q3'
        elif token[1] == 'Comentario' or token[1] == 'Paréntesis que cierra' or token[1] in O or token[1] == 'Enter':
            return 'q8'
        else: return 'qError'
    ...
    if currentState == 'q3':
        if token[1] == 'Variable' or token[1] == 'Entero' or token[1] == 'Real':
            return 'q4'
        elif token[1] == 'Paréntesis que abre' or token[1] == 'Comentario' or token[1] in O or token[1] == 'Enter':
            return 'q8'
        elif token[1] == 'Paréntesis que cierra':
            return 'q0'
        else: return 'qError'
    ...
    if currentState == 'q4':
        ...
        if token[1] == 'Paréntesis que abre':
            return 'q8'
        if token[1] == 'Variable' or token[1] == 'Entero' or token[1] == 'Real' or token[1] == 'Paréntesis que abre' or token[1] == 'Comentario' or token[1] == 'Enter':
            return 'q8'
        else: return 'qError'
    ...
    if currentState == 'q5':
        if token[1] in O:
            ...
            return 'q7'
        elif token[1] == 'Variable' or token[1] == 'Entero' or token[1] == 'Real' or token[1] == 'Paréntesis que abre' or token[1] == 'Paréntesis que cierra':
            return 'q8'
        elif token[1] == 'Enter':
            return 'q0'
        else: return 'qError'
    ...
    if currentState == 'q6':
        if token[1] == 'Variable' or token[1] == 'Entero' or token[1] == 'Real':
            return 'q4'
        elif token[1] == 'Paréntesis que abre' or token[1] == 'Paréntesis que cierra' or token[1] == 'Comentario' or token[1] == 'Enter' or token[1] in O:
            return 'q8'
        else: return 'qError'
    ...
    if currentState == 'q7':
        if token[1] == 'Enter':
            return 'q0'
        elif token[1] == 'Variable' or token[1] == 'Entero' or token[1] == 'Real' or token[1] == 'Paréntesis que abre' or token[1] == 'Paréntesis que cierra' or token[1] == 'Comentario' or token[1] in O:
            return 'q7'
        else: return 'qError'
...
for token, tipo in tokens:
    ...
    elif tipo == 'Paréntesis que abre':
        f.write(' <div style="color: #33FFC4 ;"')
    elif tipo == 'Paréntesis que cierra':
        f.write(' <div style="color: #A8FF33;"')
    elif tipo == 'Asignación':
